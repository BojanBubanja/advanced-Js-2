...
// secondButtonElement.addEventListener("clik", changeBackgroundColor);
...
// const thirdParagraphElement = firstParagraphElement.nextElementSibling.nextElementSibling   ALTERNATIVA
...
// / firstParagraphElement.className = "blue=bg"    NIJE RADILO
// firstParagraphElement.classList.add('blue-bg')   NIJE RADILO
